 ...
 server {
  ...
  ###### End Joomla block ######
    ...
    location / {
      ...
      add_header X-app2-message "example root section entered" always;
  ...
  location ~ \.php$ {
    ...
    # you can delete this part (sample of certbot ssl certificate port 443)
    # listen 443 ssl; # managed by Certbot
    # ssl_certificate /etc/letsencrypt/live/abinaryds.com/fullchain.pem; # managed by Certbot
    # ssl_certificate_key /etc/letsencrypt/live/abinaryds.com/privkey.pem; # managed by Certbot
